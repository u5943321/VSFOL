...
(Tp1 (qform2IL [‘b:1->B’] ‘R o Pa(a:1->A,b:1->B) = TRUE’)) >>
 rw[IN_Tp1,Eq_property_TRUE,o_assoc,Pa_distr,one_to_one_id,idR,idL])
...
(fconv_tac (basic_fconv no_conv forall_cross_fconv) >>
 rpt strip_tac >> rw[mulf0IL_def,Holds_def,o_assoc,Eq_property_TRUE,Pa_distr,p12_of_Pa,Pair_def',Mul_def,Add_def])
(form_goal
